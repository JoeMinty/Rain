...
# zookeeper
docker run --name zk1 --hostname zoo1 --privileged=true -d --env ZOO_MY_ID=1 --env "ZOO_SERVERS=server.1=0.0.0.1:2888:3888 server.2=zoo2:2888:3888 server.3=zoo3:2888:3888" zookeeper
